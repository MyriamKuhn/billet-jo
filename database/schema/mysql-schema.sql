...
CREATE TABLE `email_updates` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `email_updates_token_unique` (`token`),
  KEY `email_updates_user_id_foreign` (`user_id`),
  CONSTRAINT `email_updates_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `products` (
  ...
  `sale` decimal(15,2) DEFAULT NULL,
...
CREATE TABLE `tickets` (
  ...
  `status` enum('issued','used','refunded','cancelled') NOT NULL DEFAULT 'issued',
...
CREATE TABLE `users` (
  ...
  `twofa_recovery_codes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`twofa_recovery_codes`)),
  `twofa_secret_temp` varchar(255) DEFAULT NULL,
  `twofa_temp_expires_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2025_04_22_191726_create_carts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_04_22_194253_create_products_table',1);
